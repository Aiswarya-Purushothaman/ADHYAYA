...
import { ForgotOtpAdminFunction } from '../../utils/Axios/api';
// import { useDispatch } from 'react-redux';
// import { setUserDetails } from '../../utils/redux/slices/userAuthSlice';

const ForgotOtpAdmin: React.FC = () => {
  ...
  const handleOtpSubmit = async (e: React.FormEvent) => {
    ...
    const storedOtp = localStorage.getItem("otpforgotadmin");

    if (enteredOtp === storedOtp) {
      console.log("OTP is a match");
      localStorage.removeItem("otpforgotadmin");
  ...
  const handleResendOtp =async () => {
    ...
    const AdminDetails = localStorage.getItem("dataadmin");
    if(AdminDetails){
      console.log(AdminDetails,"AdminDetails");
      const email=AdminDetails
      const otp=await ForgotOtpAdminFunction({email})
      console.log(otp.data,"otpotp");
      localStorage.setItem("otpforgotadmin",otp.data)
    }
  };
